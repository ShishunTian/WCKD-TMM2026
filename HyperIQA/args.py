...
def Configs():
    ...
    parser.add_argument('--datapath', dest='datapath', type=str, default='/data/hlz/IQA_Database/databaserelease2/',
    ...
    parser.add_argument('--dataset', dest='dataset', type=str, default='live',
                        help='Support datasets: livec|koniq-10k|bid|live|csiq|tid2013|kadid10k')
    parser.add_argument('--svpath', dest='svpath', type=str,
                        default='/data/hlz/models/HyperIQA/Origin/')
    ...
    parser.add_argument('--batch_size', dest='batch_size', type=int, default=96,
                        help='Batch size')
    parser.add_argument('--epochs', dest='epochs', type=int, default=16,
    ...
    parser.add_argument('--cov', dest='cov', type=bool, default=False,
                        help='covariance constraint exists or not')
