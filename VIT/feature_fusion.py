...
class CrossAttentionFusion(nn.Module):
    ...
    def forward(self, quality_features, segmentation_features):
        ...
        quality_features = quality_features.permute(1, 0, 2)  # [seq_len, batch_size, embed_dim]
        ...
        return attn_output.permute(1, 0, 2)[:, 0]  # [batch_size, seq_len, embed_dim] -> [batch_size, embed_dim]
