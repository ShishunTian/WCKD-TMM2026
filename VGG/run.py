...
def main(config,device):
    ...
    solver = Base_VGG(config, device, folder_path[config.dataset], train_index, test_index)
    ...
    # srcc, plcc, pred, gt = solver.test_scatter(svPath, config.seed)
    # print(f'SROCC={srcc},PLCC={plcc}')
    # plot_scatter(pred,gt,config.dataset)

    # srcc, plcc = solver.cross_test(svPath, config.seed)
    # print(f'SROCC={srcc},PLCC={plcc}')
